...
export const localeData: LocaleData = {
  ...
  levelCopy: {
    "world-01-level-01": {
      name: "Первая искра",
      concept: "Дойдите до цели и зажгите ее",
      designerNotes: "Начните с быстрой победы: один шаг и одна активация.",
    },
    "world-01-level-02": {
      name: "Повернись к искре",
      concept: "Если цель не впереди, сначала повернитесь",
    ...
    "world-01-level-05": {
      name: "Двойной марш",
      concept: "Используйте Процесс 1, чтобы повторить одинаковую ходьбу",
      designerNotes: "Маршрут длиннее главной программы. Сохраните повторяющиеся два шага в Процессе 1.",
    },
    "world-01-level-06": {
      name: "Линия сигналов",
      concept: "Процесс может упаковать повторяющуюся пару действий",
      designerNotes: "Повторяется идея «зажечь и шагнуть», а не только движение.",
    },
    "world-01-level-07": {
      name: "Эхо поворота",
      concept: "Используйте тот же процесс снова после смены направления",
      designerNotes: "Соберите фразу «дойти и зажечь», затем поверните робота и используйте ее снова.",
    },
    "world-01-level-08": {
      name: "Эхо прыжка",
      concept: "Процессы могут скрывать повторяющийся ритм высоты",
      designerNotes: "Повторяющаяся фраза: прыгнуть, зажечь, спуститься. Последний спуск пропускается, когда загорается последняя цель.",
    },
    "world-01-level-09": {
      name: "Вложенный поворот",
      concept: "Процесс 2 может использовать Процесс 1 внутри более крупной идеи",
      designerNotes: "Один помощник отвечает за расстояние. Второй поворачивает и переиспользует это расстояние.",
    },
    "world-01-level-10": {
      name: "Спираль искр",
      concept: "Планируйте через переиспользуемые фрагменты, а не полный маршрут",
      designerNotes: "Ищите угловую фразу, которая повторяется после каждой цели.",
    },
    "world-01-level-11": {
      name: "Ключ-мост",
      concept: "Переключатель может изменить поле до того, как маршрут станет возможным",
      designerNotes: "Маршрут невозможен, пока переключатель не передвинет мост в пустое место.",
    },
    "world-02-level-02": {
