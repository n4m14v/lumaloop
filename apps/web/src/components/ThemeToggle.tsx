...
export function ThemeToggle({
  ...
  return (
    ...
    >
      <div
        className={[
          "absolute h-6 w-6 rounded-full border border-[rgba(255,255,255,0.12)] bg-[linear-gradient(180deg,var(--accent)_0%,var(--accent-strong)_100%)] transition-all duration-300 ease-in-out",
          isDark
            ? "translate-x-6 shadow-[0_0_18px_var(--accent-shadow)]"
            : "translate-x-0 shadow-[0_0_14px_var(--accent-shadow)]",
        ].join(" ")}
      />

      <div className="z-10 grid h-full w-full grid-cols-2 place-items-center">
        <Sun
